...
<template>
    ...
    <div class="userLikeListWrapper" >
        ...
        <div class="userLike" v-for="(item, index) in userSongList.data" :key="index">
        ...
        <van-tabs v-model:active="active">
                ...
                <van-tab title="创建的歌单">
                    ...
                    <div class="userCreate" v-for="(item, index) in userSongList.data" :key="index">
                        ...
                        <div class="picture">
                            ...
                            <div class="songlistInfo">
                                ...
                                <div class="number">
                                    ...
                                    <div class="playCount">
                                        &nbsp;&nbsp;播放{{ item.playCount<10000?item.playCount:((item.playCount)/10000).toFixed(1)+'万'  }}次
                                    </div>
                                    </div>
                ...
                <van-tab title="收藏的歌单">
                    ...
                    <div class="userTreasure" v-for="(item, index) in userSongList.data" :key="index">
