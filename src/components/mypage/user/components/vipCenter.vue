...
const time=ref({
   ...
   watchEffect(()=>{
        ...
        if(infoData.data.associator!=null&&infoData.data.musicPackage!=null&&infoData.data.voiceBookVip!=null){
            dateCalc('associator')
...
<el-drawer
  ...
  <div class="wrapper">
        ...
        <div class="total">
            ...
            <div class="level">
                等级：{{ infoData.data.associator.vipLevel }}
            </div>
        ...
        <div class="musicPackage">
            ...
            <div class="level">
                等级：{{ infoData.data.musicPackage.vipLevel }}
            </div>
        </div>
        ...
        <div class="voiceBook">
            ...
            <div class="level">
                等级：{{ infoData.data.voiceBookVip.vipLevel }}
            </div>
