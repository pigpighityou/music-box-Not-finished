  ...
  <van-tabs v-model:active="active">
    <van-tab title="收藏的专辑">
      <div class="storeAlbumWrapper">
        <div
          class="storeAlbum"
          v-for="(item3, index3) in storeAlbumData.data"
          :key="index3"
        >
          <div class="album">
          ...
          <div class="desc">
            ...
            <div
              class="singer"
              v-for="(item4, index4) in item3.artists"
              :key="index4"
            >
              {{ item4.name }}
            </div>
    ...
    <van-tab title="收藏的视频">
      <div class="storeMVWrapper">
        <div
          class="storeMV"
          v-for="(item, index) in storeMvData.data"
          :key="index"
        >
          <div class="pic">
            <router-link
              :to="{ name: 'mvPlayerAlias', params: { id: item.vid } }"
            >
          ...
          <div class="desc">
            ...
            <div
              class="creator"
              v-for="(item1, index1) in item.creator"
              :key="index"
            >
              {{ item1.userName }}
            </div>
