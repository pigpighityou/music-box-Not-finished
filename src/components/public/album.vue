...
<div class="desc">
  ...
  <div class="total">
    ...
    <div class="author" v-for="(item4, index4) in albumDetail.data.album?.artists" :key="index4">
          歌手：{{  item4.name }}
    </div>
...
<div class="listalbumsWrapper">
  ...
  <div class="listalbums" >
      ...
      <div class="listalbum" v-for="(item, index) in albumDetail.data.songs" :key="index">
        <div class="rankWrapper">
          ...
          <div class="albumWrapper" @click="clickHandler(index)">
            ...
            <div class="twoItems">
              <div class="albumAuthor" v-for="(item1, index1) in item.ar" :key="index1">
              {{ item1.name  }}
              </div>
              <div class="album">
                {{ item.al.name }}
