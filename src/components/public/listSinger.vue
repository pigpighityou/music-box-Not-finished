<template>
  ...
  <div class="singerWrapper">
    ...
    <div
      class="alias"
      v-for="(item1, index1) in singerDetail.data.artist?.alias"
      :key="index"
    >
      <div class="aliasName">
        {{ item1 }}
    ...
    <div class="fans">
      {{
        singerFans.data.fansCnt < 10000
          ? singerFans.data.fansCnt
          : (singerFans.data.fansCnt / 10000).toFixed(1) + "万"
      }}
      粉丝
    </div>
    <div class="identity">
        ...
        <div class="wiki">
          <div class="artistName">
            ...
            <div class="picWrapper">
              <img
                :src="singerWiki.data.avatarPicUrl"
                alt="pic3"
                class="pic4"
              />
            </div>
          ...
          <div class="brief1">&nbsp;&nbsp;{{ singerWiki.data?.desc }}</div>

          <div class="productionLink" @click="drawer = true">
            <div class="proTitle">艺人经历</div>
            <div class="proIcon">
          ...
          <el-drawer
            ...
            size="90%"
          >
            <div class="production" v-html="singerWiki.data.production"></div>
          </el-drawer>
        </div>
      </div>
    </van-tab>
    <van-tab title="歌曲">
      <div class="listSongsWrapper">
        <div class="listSongs">
          <div
            class="listSong"
            v-for="(item, index) in singerHotSongAPI?.data.songs"
            :key="index"
          >
