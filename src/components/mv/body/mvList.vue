        ...
        <div class="firstWrapper" v-if="index==0">
            ...
            <div class="mvInner">
                ...
                <div class="firstMvPic" @click="num=index">
                    ...
                    <div class="topRank">
                            ...
                            <div class="firstLastRank">
                                ...
                                <div class="down" v-if="item.lastRank-index-1<0">
                                    <svg class="downIcon" v-if="item.lastRank!=-1" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-ea893728=""><path fill="currentColor" d="m192 384 320 384 320-384z"></path></svg>
                                    <div class="new" v-if="item.lastRank===-1">
                                        --
                                    </div>
                                ...
                                <div class="up" v-else-if="item.lastRank-index-1>0">
                                    ...
                                    <svg class="upIcon" v-if="item.lastRank!=-1" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-ea893728=""><path fill="currentColor" d="M512 320 192 704h639.936z"></path></svg>
                                    <div class="new" v-if="item.lastRank===-1">
                                        --
                                    </div>
                                    <div class="compareNum">
                    ...
                    <div class="overlay" v-if="index!=num">
            ...
            <van-grid :column-num="3" :gutter="25"
                square="true"
            clickable="true"
            border="true"
           
            icon-size="8vw" class="grid">
            <van-grid-item class="item" icon="apps-o" text="分类视频"  to="/mv/category" />
